...
public class ClientEvents {
	...
	public static void registerKeys(RegisterKeyMappingsEvent event){
		...
		event.register(lights_toggle = new KeyMapping("key.fvtm.vehicle_lights", KeyConflictContext.VEHICLE, InputConstants.Type.KEYSYM, InputConstants.KEY_L, category));
